namespace SyntaxWinApp03
{
    public partial class FrmMain : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string PainPoint = CboPain.SelectedItem.ToString();
                ...
                switch (PainPoint)
                {
                    case "머리":
                        ...
                        break;
                    case "목":
                        MessageBox.Show("이빈후과로 갑니다", "진료과선택");
                        break;
                    case "눈":
        ...
        private void CboPain_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            var selectedPoint = CboPain.SelectedItem.ToString();
        ...
        private void BtnWhile_Click(object sender, EventArgs e)
        {
            ...
            while (true) 
            {
                ...
                if(clickNum == 10)
                {
                    break; // 반복문 탈출 for, foreach while문
                    // continue; 도 파악할것
                    // goto; 는 왠만하면 쓰지 말것
                }
            }
