...
namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load_1(object sender, EventArgs e)
        {
            ...
            //CboFonts.Items.AddRange(Fonts);   // 간단하지만 UI가 별로임
            ...
            toolTip1.SetToolTip(BtnModal, "모당창 연습 버튼입니다.");     // 만든곳에 올리면 글자가 나옴
        ...
        private void ChangeFont()
        {
            ...
            // CboFont에서 선택된 글자로, 글자크기 12, 글자크기 
            TxtRsult.Font = new Font((string)CboFonts.SelectedItem, 12, style);
        }
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frmModal.ShowDialog();      // 모달창 띄우기  임마가 사라져야 다른창을 건드릴 수 있다
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            frmModaless.BackColor = Color.Cyan;
            // 모델리스창을 모달창처럼 메인창 정중앙에 위치하려면 계산이 필요
            ...
            frmModaless.Show(this);      // 모달창 띄우기  임마가 사라져야 다른창을 건드릴 수 있다
        }

        private void BtnMsgBox_Click(object sender, EventArgs e)
        {
            // 메시지박스 -> 모달창(임마를 닫아야 다른창을 건디릴수 있다)
            MessageBox.Show(TxtRsult.Text, "텍스트박스 문장",
        ...
        private void BtnNode_Click(object sender, EventArgs e)
        {
            ...
            TrvDummy.SelectedNode.Expand(); // 트리확장Expand, 트리축소 Collapse
            TreeToList();
        ...
        private void TreeToList(TreeNode node)
        {
            ...
            item.ImageIndex = 0; // 아이템의 이미지인텍스를 지정
        ...
        private void BtnOpenImage_Click(object sender, EventArgs e)
        {
            ...
            DlgOpenImage.FileName = "Image Files(*.bmp;*.jpg;*.png)|*.bmp;*.jpg;*.png";
            ...
            if (DlgOpenImage.ShowDialog() == DialogResult.OK)
            {
                ...
                // PictureBoxSizeMode.StretchImage 이미지가 넓이,높이
            }
        }
        ...
        private void Lblurl_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        {
