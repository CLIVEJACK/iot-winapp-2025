namespace SyntaxWinApp03
{
    ...
    {
        private string filePath = "smaple.rtf"; // Rich Text Format(msWord 유사)
        public FrmMain()
        {
            InitializeComponent();
        }
        ...
        {
            //string filePath = "smaple.txt"; // smaple.txt 파일 저장명
            ...
            //try
            //{
            //    // 1.파일관련된 메서드가 포함된 클래스
            //    //File.WriteAllText(filePath, RtbNote.Text);

            //    // 2. Rich Test Format으로 저장
        ...
        {
            //string filePath = "smaple.txt"; // 읽어올 파일
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (currFont.Bold)
            {
                newStyle = currFont.Style & ~FontStyle.Bold; // Bold제거
            }
            else
            {
                newStyle = currFont.Style | FontStyle.Bold;  // Bold추가
